	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<table class="table">
				  	<tr>
				  		<th>銷貨編號</th><th>商品類別</th><th>商品名稱</th><th>商品價格</th><th>銷貨時間</th><th>發貨時間</th><th>購買者編號</th><th>確認換貨</th>
				  	</tr>
				  	<c:forEach items="${SalesOrderList}" var="SalesOrder">
					  	<tr>
					    	...
					    	<td>${SalesOrder.manid}</td>
			             	<td><a class="btn btn-primary" href="changeconfirm?id=${SalesOrder.id}">確認換貨</a>
