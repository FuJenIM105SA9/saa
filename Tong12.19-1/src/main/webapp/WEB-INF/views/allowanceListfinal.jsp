	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12">
				<table class="table">
				  	<tr>
				  		<th>折讓編號</th><th>商品編號</th><th>會員編號</th><th>銷貨編號</th><th>折讓申請時間</th><th>折讓確認時間</th><th>折讓金額</th>
				  	</tr>
				  	<c:forEach items="${AllowanceOrderList}" var="AllowanceOrder">
					  	<tr>
					  	    <td>${AllowanceOrder.getAId()}</td>
					  	    <td>${AllowanceOrder.productId}</td>
					  		<td>${AllowanceOrder.managerId}</td>
					  		<td>${AllowanceOrder.soid}</td>
					    	<td>${AllowanceOrder.allowanceOrderTime}</td>
					    	<td>${AllowanceOrder.allowanceConfirmTime}</td>
					    	<td>${AllowanceOrder.aPrice}</td>
